  ...
  return {
    ...
    concourses: [
      ...
      },
      {
        ...
        kind: 'hubSlice',
        fare: 'free',
        rect: { x0: -44, x1: -18, z0: west - 10.5, z1: west + 24 },
        depiction: 'walkable',
        nameJp: 'オレンジロード',
        nameEn: 'Orange Road',
        confidence: 'high',
    ...
    gateGroups: [
      ...
      },
      {
        ...
        from: 'paid-east',
        to: 'free-east',
        rect: { x0: f.x1 + 10.3, x1: f.x1 + 12, z0: east, z1: east + 12 },
        cross: 'x',
        passages: 10,
        staffed: true,
        depiction: 'vista',
      ...
      },
      {
        ...
        from: 'paid-east',
        to: 'free-east',
        rect: { x0: f.x1 + 10.3, x1: f.x1 + 12, z0: east + 12.5, z1: east + 20 },
        cross: 'x',
        passages: 6,
        staffed: true,
        depiction: 'signOnly',
      ...
      },
      {
        ...
        from: 'paid-west',
        to: 'free-west',
        rect: { x0: -20, x1: -18.3, z0: west - 10.5, z1: west - 1 },
        cross: 'x',
        passages: 8,
        staffed: true,
        depiction: 'vista',
    ...
    concourses: [
      {
        ...
        rect: f.across(9, 0, take, take + 7.5),
        depiction: 'walkable',
        confidence: 'high',
      },
      {
        ...
        kind: 'compact',
        fare: 'free',
        rect: { x0: -20, x1: -9, z0: take - 1, z1: take + 9.5 },
        depiction: 'walkable',
        confidence: 'estimated',
      },
      {
        ...
        rect: f.across(7, 5, omote, omote + 8.5),
        depiction: 'walkable',
        confidence: 'high',
      },
      {
        ...
        kind: 'compact',
        fare: 'free',
        rect: { x0: f.x1 + 5, x1: f.x1 + 20, z0: omote - 3, z1: omote + 11 },
        depiction: 'walkable',
        confidence: 'high',
      },
    ],
    ...
    gateGroups: [
      {
        ...
        from: 'paid-takeshita',
        to: 'free-takeshita',
        rect: { x0: -11, x1: -9.3, z0: take, z1: take + 7.5 },
        cross: 'x',
        passages: 6,
        wideAt: 'end',
        staffed: true,
      ...
      },
      {
        ...
        from: 'paid-omote',
        to: 'free-omote',
        rect: { x0: f.x1 + 3.3, x1: f.x1 + 5, z0: omote, z1: omote + 8.5 },
        cross: 'x',
        passages: 7,
        staffed: true,
        depiction: 'walkable',
    ...
    commercialZones: [
      {
        ...
        category: 'konbini',
        brand: 'NewDays',
        rect: { x0: f.x1 + 12, x1: f.x1 + 19, z0: omote + 2, z1: omote + 10 },
        enterable: false,
        confidence: 'high',
      },
    ],
...
function shibuya(i: number): Draft {
  ...
  return {
    ...
    concourses: [
      { id: 'paid-hachiko', levelId: '1f', kind: 'hubSlice', fare: 'paid', rect: f.across(12, 10, hachiko - 10.5, hachiko + 18), depiction: 'walkable', confidence: 'high' },
      { id: 'free-hachiko', levelId: '1f', kind: 'hubSlice', fare: 'free', rect: { x0: -34, x1: -12, z0: hachiko - 10.5, z1: hachiko + 22 }, depiction: 'walkable', confidence: 'estimated' },
    ...
    gateGroups: [
      ...
      },
      {
        ...
        from: 'paid-hachiko',
        to: 'free-hachiko',
        rect: { x0: -13.7, x1: -12, z0: hachiko + 18.5, z1: hachiko + 22 },
        cross: 'x',
        passages: 2,
        exitOnly: true,
        depiction: 'walkable',
      ...
      },
      {
        ...
        from: 'paid-hachiko',
        to: 'free-hachiko',
        rect: { x0: -13.7, x1: -12, z0: hachiko - 10.5, z1: hachiko - 1 },
        cross: 'x',
        passages: 8,
        staffed: true,
        depiction: 'vista',
    ...
    gateGroups: [
      {
        ...
        from: 'paid-hall',
        to: 'free-hall',
        rect: { x0: f.x1 + 8.3, x1: f.x1 + 10, z0: hall + 7.5, z1: hall + 14 },
        cross: 'x',
        passages: 5,
        wideAt: 'end',
        staffed: true,
      ...
      },
      {
        ...
        from: 'paid-hall',
        to: 'free-hall',
        rect: { x0: f.x1 + 8.3, x1: f.x1 + 10, z0: hall, z1: hall + 6.5 },
        cross: 'x',
        passages: 5,
        staffed: true,
