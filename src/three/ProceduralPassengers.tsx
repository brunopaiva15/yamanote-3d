...
// fois à partir de son descripteur d'apparence (systems/appearance) :
// corpulence en géométrie (torse en LatheGeometry), habits haut/bas
// indépendants, coiffures, accessoires et visage en CanvasTexture. Les bras
...
export function ProceduralPassengers() {
  initPassengers();
