...
const OUT = '/tmp/claude-0/-home-user-yamanote-3d/5d0fc796-2b0f-57bf-be70-0b8dd7040339/scratchpad/shots2';
...
const shot = async (n) => {
  ...
  console.log(`  ${n}`, JSON.stringify(await page.evaluate(() => window.__probeWhere())));
};
